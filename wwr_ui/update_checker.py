...
LATEST_RELEASE_DOWNLOAD_PAGE_URL = (
    "https://github.com/DualVission/twwrando-dv_im/releases/latest"
)
LATEST_RELEASE_API_URL = (
    "https://api.github.com/DualVission/twwrando-dv_im/releases/latest"
)
    ...
    try:
        with urllib.request.urlopen(LATEST_RELEASE_API_URL) as page:
            ...
            if "-BETA" in VERSION:
                ...
                if LooseVersion(latest_version_name) >= LooseVersion(
                    version_without_beta
                ):
