...
OPTIONS = OrderedDict(
    [
        ...
        ("sail_color", "Selects sail to use in game."),
        ("custom_bck_entry", "Selects animation deviation. May effect gameplay."),
        (
            "custom_color_preset",
            "This allows you to select from preset color combinations chosen by the author of the selected player model.",
        ),
        ("randomized_gear", "Inventory items that will be randomized."),
        (
            "starting_gear",
            "Items that will be in Link's inventory at the start of a new game.",
        ),
        ("starting_pohs", "Amount of extra pieces of heart that you start with."),
        ("starting_hcs", "Amount of extra heart containers that you start with."),
        (
            "starting_bh",
        ...
        ("remove_music", "Mutes all ingame music."),
        ("randomize_enemies", "Randomizes the placement of non-boss enemies."),
    ]
)
